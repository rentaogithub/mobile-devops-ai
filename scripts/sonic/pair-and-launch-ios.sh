...
Usage:
  sh scripts/sonic/pair-and-launch-ios.sh [device-udid] [bundle-id]
...
Examples:
  sh scripts/sonic/pair-and-launch-ios.sh
  sh scripts/sonic/pair-and-launch-ios.sh 00008101-0015192E0178001E
  sh scripts/sonic/pair-and-launch-ios.sh 00008101-0015192E0178001E com.nndev.im
EOF
}

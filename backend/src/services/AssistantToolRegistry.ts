...
const tools: AssistantTool[] = [
  {
    name: 'platform_cross_system_diagnosis', domain: 'platform', role: 'viewer', riskLevel: 'read', approvalsRequired: 0, timeoutMs: 180_000,
  ...
  {
    name: 'logs_search', domain: 'logs', role: 'viewer', riskLevel: 'read', approvalsRequired: 0, timeoutMs: 180_000,
  ...
  {
    name: 'api_search', domain: 'api', role: 'viewer', riskLevel: 'read', approvalsRequired: 0, timeoutMs: 20_000,
  ...
  {
    name: 'routes_search', domain: 'api', role: 'viewer', riskLevel: 'read', approvalsRequired: 0, timeoutMs: 30_000,
  ...
  {
    name: 'pods_analyze_impact', domain: 'pods', role: 'viewer', riskLevel: 'read', approvalsRequired: 0, timeoutMs: 60_000,
  ...
  {
    name: 'workflow_overview', domain: 'workflow', role: 'viewer', riskLevel: 'read', approvalsRequired: 0, timeoutMs: 10_000,
  ...
  {
    name: 'workflow_list_issues', domain: 'workflow', role: 'viewer', riskLevel: 'read', approvalsRequired: 0, timeoutMs: 10_000,
  ...
  {
    name: 'workflow_get_issue', domain: 'workflow', role: 'viewer', riskLevel: 'read', approvalsRequired: 0, timeoutMs: 10_000,
  ...
  {
    name: 'workflow_list_tasks', domain: 'workflow', role: 'viewer', riskLevel: 'read', approvalsRequired: 0, timeoutMs: 10_000,
  ...
  {
    name: 'workflow_verify_task', domain: 'workflow', role: 'viewer', riskLevel: 'read', approvalsRequired: 0, timeoutMs: 10_000,
  ...
  {
    name: 'workflow_change_impact', domain: 'workflow', role: 'operator', riskLevel: 'confirm', approvalsRequired: 1, timeoutMs: 60_000,
  ...
  {
    name: 'workflow_release_gate_preview', domain: 'workflow', role: 'viewer', riskLevel: 'read', approvalsRequired: 0, timeoutMs: 10_000,
  ...
  {
    name: 'workflow_verify_release_health', domain: 'workflow', role: 'viewer', riskLevel: 'read', approvalsRequired: 0, timeoutMs: 10_000,
  ...
  {
    name: 'task_track', domain: 'workflow', role: 'viewer', riskLevel: 'read', approvalsRequired: 0, timeoutMs: 60_000,
  ...
  {
    name: 'workflow_create_regression_candidate', domain: 'workflow', role: 'operator', riskLevel: 'confirm', approvalsRequired: 1, timeoutMs: 20_000,
  ...
  {
    name: 'workflow_generate_xcuitest', domain: 'workflow', role: 'operator', riskLevel: 'confirm', approvalsRequired: 1, timeoutMs: 120_000,
  ...
  {
    name: 'crash_list_history', domain: 'crash', role: 'viewer', riskLevel: 'read', approvalsRequired: 0, timeoutMs: 10_000,
  ...
  {
    name: 'crash_get_history', domain: 'crash', role: 'viewer', riskLevel: 'read', approvalsRequired: 0, timeoutMs: 10_000,
  ...
  {
    name: 'crash_analyze_history', domain: 'crash', role: 'operator', riskLevel: 'confirm', approvalsRequired: 1, timeoutMs: 120_000,
  ...
  {
    name: 'crash_symbolicate_attachment', domain: 'crash', role: 'operator', riskLevel: 'confirm', approvalsRequired: 1, timeoutMs: 180_000,
  ...
  {
    name: 'crash_compare_versions', domain: 'crash', role: 'viewer', riskLevel: 'read', approvalsRequired: 0, timeoutMs: 180_000,
  ...
  {
    name: 'dsym_diagnose_missing', domain: 'crash', role: 'viewer', riskLevel: 'read', approvalsRequired: 0, timeoutMs: 20_000,
  ...
  {
    name: 'sentry_list_issues', domain: 'crash', role: 'viewer', riskLevel: 'read', approvalsRequired: 0, timeoutMs: 120_000,
  ...
  {
    name: 'sentry_find_user_issues', domain: 'crash', role: 'viewer', riskLevel: 'read', approvalsRequired: 0, timeoutMs: 120_000,
  ...
  {
    name: 'sentry_get_issue_context', domain: 'crash', role: 'viewer', riskLevel: 'read', approvalsRequired: 0, timeoutMs: 120_000,
  ...
  {
    name: 'cicd_list_builds', domain: 'cicd', role: 'viewer', riskLevel: 'read', approvalsRequired: 0, timeoutMs: 30_000,
  ...
  {
    name: 'cicd_get_build_log', domain: 'cicd', role: 'viewer', riskLevel: 'read', approvalsRequired: 0, timeoutMs: 40_000,
  ...
  {
    name: 'cicd_analyze_build_failure', domain: 'cicd', role: 'viewer', riskLevel: 'read', approvalsRequired: 0, timeoutMs: 120_000,
  ...
  {
    name: 'cicd_verify_build', domain: 'cicd', role: 'viewer', riskLevel: 'read', approvalsRequired: 0, timeoutMs: 60_000,
  ...
  {
    name: 'cicd_trigger_build', domain: 'cicd', role: 'operator', riskLevel: 'confirm', approvalsRequired: 1, timeoutMs: 60_000, idempotent: true,
  ...
  {
    name: 'cicd_retry_build', domain: 'cicd', role: 'operator', riskLevel: 'confirm', approvalsRequired: 1, timeoutMs: 60_000, idempotent: true,
  ...
  {
    name: 'cicd_trigger_release', domain: 'cicd', role: 'admin', riskLevel: 'high', approvalsRequired: 2, timeoutMs: 60_000, idempotent: true,
    description: '触发 Jenkins 发布到 Pgyer、TestFlight 或 AppStore。必须指定质量门禁源构建并二次确认；Apple 渠道验证密码在审批界面单独输入，不进入模型上下文。',
    parameters: objectSchema({
  ...
  {
    name: 'quality_list_tasks', domain: 'quality', role: 'viewer', riskLevel: 'read', approvalsRequired: 0, timeoutMs: 30_000,
    description: '实时查询 Jenkins 自动质检最近任务。',
    parameters: objectSchema({ limit: { type: 'number', minimum: 1, maximum: 30 } }),
    execute: (args) => jenkinsAssistantService.listBuilds(args.limit || 10, true),
  },
  {
    name: 'quality_daily_report', domain: 'quality', role: 'viewer', riskLevel: 'read', approvalsRequired: 0, timeoutMs: 180_000,
  ...
  {
    name: 'quality_create_task', domain: 'quality', role: 'operator', riskLevel: 'confirm', approvalsRequired: 1, timeoutMs: 60_000, idempotent: true,
  ...
  {
    name: 'quality_retry_task', domain: 'quality', role: 'operator', riskLevel: 'confirm', approvalsRequired: 1, timeoutMs: 60_000, idempotent: true,
...
export class AssistantToolRegistry {
  listForUser(user: PlatformUser) {
    return tools.filter((tool) => ROLE_RANK[user.role] >= ROLE_RANK[tool.role]);
  }
  ...
  assertAllowed(name: string, user: PlatformUser) {
    ...
    if (ROLE_RANK[user.role] < ROLE_RANK[tool.role]) throw new Error(`当前角色无权调用 ${name}`);
    return tool;
  }
